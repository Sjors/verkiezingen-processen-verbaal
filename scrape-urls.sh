...
pushd 2024-EP
    ...
    ../urls-from-html.py https://www.leusden.nl/verkiezingen/uitslagen/uitslag-verkiezing-europees-parlement-2024 ".pdf" https://www.leusden.nl > "$(stad 0327)"
    ../urls-from-html.py https://www.lingewaard.nl/uitslag-tweede-kamerverkiezing-2023 > "$(stad 1705)"
    ../urls-from-html.py https://www.lisse.nl/verkiezingen/uitslag-verkiezing-europees-parlement-2024 ".pdf" https://www.lisse.nl > "$(stad 0553)"
    ...
    ../urls-from-html.py https://www.leeuwarden.nl/uitslagen-en-processen-verbaal-verkiezing-europees-parlement-2024/ | sort -u --version-sort
