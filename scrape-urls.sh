...
pushd 2024-EP
    ...
    ../urls-from-html.py https://www.geldrop-mierlo.nl/voorlopige-uitslag-verkiezing-europees-parlement-2024 > "$(stad 1771)"
    ...
    # H
    ../urls-from-html.py https://www.gemeentehw.nl/verkiezing-europees-parlement-2024/processen-verbaal-en-formulieren/ > "$(stad 1963)"
    ...
    ../urls-from-html.py https://www.hardinxveld-giessendam.nl/Bestuur/Gemeenteraad/Verkiezingen/Uitslag_Tweede_Kamerverkiezing/Processen_verbaal_Europees_Parlement_Hardinxveld_Giessendam ".pdf" https://www.hardinxveld-giessendam.nl/ > "$(stad 0523)"
    ...
    ../urls-from-html.py https://www.heemskerk.nl/over-heemskerk/verkiezingen/verkiezing-europees-parlement-2024 ".pdf" https://www.heemskerk.nl > "$(stad 0396)"
    ...
    ../urls-from-html.py https://www.heeze-leende.nl/uitslagen-verkiezing-europees-parlement-2024 > "$(stad 1658)"
    ...
    ../urls-from-html.py https://www.helmond.nl/verkiezing-europees-parlement-2024 ".pdf" https://helmond.nl | sed "s/00008524-0794_Uitslag_Stembureau_101_Ameide_TK23.pdf000085/000085/" > "$(stad 0794)"
    ...
    ../urls-from-html.py https://www.hillegom.nl/verkiezingen/uitslag-verkiezing-europees-parlement-2024 ".pdf" https://www.hillegom.nl > "$(stad 0534)"
    ../urls-from-html.py https://www.hilvarenbeek.nl/verkiezingen/uitslagen ".pdf" http://hilvarenbeek.nl > "$(stad 0798)"
    ../urls-from-html.py https://hilversum.nl/verkiezingen/verkiezingsuitslagen-verkiezing-europees-parlement-2024 > "$(stad 0402)"
    ../urls-from-html.py https://www.hofvantwente.nl/bestuur/verkiezing-europees-parlement-2024 "(TK_2023|TK23).*pdf" https://www.hofvantwente.nl > "$(stad 1735)"
    ../urls-from-html.py https://www.hollandskroon.nl/inwoners/verkiezingen/uitslagen-verkiezing-europees-parlement-2024 ".pdf" https://www.hollandskroon.nl > "$(stad 1911)"
