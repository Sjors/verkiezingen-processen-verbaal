...
pushd 2024-EP
    ...
    ../urls-from-html.py https://www.oldebroek.nl/Bestuur_en_organisatie/Verkiezingen/Uitslagen_verkiezingen/Processen_verbaal_Europees_Parlement_2024 ".pdf" https://www.oldebroek.nl > "$(stad 0269)"
    ...
    ../urls-from-html.py https://www.ouder-amstel.nl/Home/Verkiezingen/Definitieve_uitslag_Europees_Parlement_2024 ".pdf" https://www.ouder-amstel.nl > "$(stad 0437)"
    ...
    # S
    ../urls-from-html.py https://www.schagen.nl/verkiezing-europees-parlement-2024 > "$(stad 0441)"
    ../urls-from-html.py https://www.scherpenzeel.nl/uitslagen-verkiezing-europees-parlement-2024 > "$(stad 0279)"
    ...
    ../urls-from-html.py https://www.simpelveld.nl/uitslag-verkiezing-europees-parlement-2024 > "$(stad 0965)"
    ../urls-from-html.py https://www.sint-michielsgestel.nl/verkiezingen/uitslagen > "$(stad 0845)"
    ../urls-from-html.py https://www.sittard-geleen.nl/Bestuur/Verkiezingen/Europees_Parlement_2024/UItslag_verkiezingen_TK_2023 "objectid" https://www.sittard-geleen.nl > "$(stad 1883)"
    ...
    ../urls-from-html.py https://www.smallingerland.nl/Onderwerpen/Verkiezingen/Uitslag_Europees_Parlement_2024 "/Uitslag_Europees_Parlement_2024/" https://www.smallingerland.nl | grep -v osv4_3 > "$(stad 0090)"
    ../urls-from-html.py https://www.soest.nl/verkiezingen/uitslag-verkiezingen ".pdf" https://www.soest.nl > "$(stad 0342)"
    ../urls-from-html.py https://www.someren.nl/raad-en-college/verkiezingen/verkiezing-europees-parlement-2024/definitieve-uitslag ".pdf" https://www.someren.nl > "$(stad 0847)"
    ...
    ../urls-from-html.py https://www.gemeente-steenbergen.nl/inwoners_overzicht/verkiezingen/Europees_Parlement_2024/processen-verbaal/ bestand | grep -v osv4 > "$(stad 0851)"
    ../urls-from-html.py https://www.steenwijkerland.nl/Over_Steenwijkerland/Verkiezingen/Uitslagen_verkiezingen/Voorlopige_uitslag_Europees_Parlement/Processen_verbaal_van_de_stembureaus/Donderdag_23_november_2023 ".pdf" https://www.steenwijkerland.nl > "$(stad 1708)"
    ../urls-from-html.py https://www.steenwijkerland.nl/Over_Steenwijkerland/Verkiezingen/Uitslagen_verkiezingen/Voorlopige_uitslag_Europees_Parlement/Processen_verbaal_van_de_stembureaus/Woensdag_22_november_2023 ".pdf" https://www.steenwijkerland.nl >> "$(stad 1708)"
    ...
    ../urls-from-html.py https://stichtsevecht.nl/onderwerp/8115/uitslagen-verkiezingen-europees-parlement-2024-en-processen-verbaal/ > "$(stad 1904)"
    ...
    ../urls-from-html.py https://www.tubbergen.nl/verkiezing-europees-parlement-2024 "download" https://www.tubbergen.nl | grep -v 4544 | grep -v 4556 | grep -v 4557 | grep -v 4611 | grep -v 4612  | grep -v 4613 | sort | uniq  > "$(stad 0183)"
