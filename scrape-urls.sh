...
pushd 2024-EP
    ...
    # M
    ../urls-from-html.py https://www.maasdriel.nl/inwoner-en-ondernemer/verkiezingen/verkiezing-europees-parlement-2024/uitslagen-per-stembureau-verkiezing-europees-parlement-2024 ".pdf" https://www.maasdriel.nl > "$(stad 0263)"
    ...
    ../urls-from-html.py https://www.medemblik.nl/raad-en-bestuur/verkiezingen-europees-parlement-2024/voorlopige-uitslag-verkiezing-europees-parlement-2024/alle-uitslagen-per-stembureau-proces-verbalen ".pdf" https://www.medemblik.nl > "$(stad 0420)"
    ...
    ../urls-from-html.py https://www.moerdijk.nl/web/Verkiezingen/verkiezingen-tweede-kamer-22-november/Aanmelden/Voorlopige-uitslag-verkiezing-europees-parlement-2024.html ".pdf" https://www.moerdijk.nl | grep -v factsheet > "$(stad 1709)"
