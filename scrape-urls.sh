...
pushd 2024-EP
    ...
    # E
    ../urls-from-html.py https://www.eindhoven.nl/bestuur-en-beleid/verkiezing-europees-parlement-2024/verkiezingsuitslagen > "$(stad 0772)"
    ...
    ../urls-from-html.py https://www.elburg.nl/Bestuur_en_organisatie/Uitslag_Europees_Parlement "pdf" https://www.elburg.nl > "$(stad 0230)"
    ../urls-from-html.py https://www.elburg.nl/Bestuur_en_organisatie/Uitslag_Europees_Parlement/Processen_verbaal_van_de_stembureaus_model_N10_2 "pdf" https://www.elburg.nl >> "$(stad 0230)"
    ../urls-from-html.py https://www.elburg.nl/Bestuur_en_organisatie/Uitslag_Europees_Parlement/Alle_bijlagen_bij_het_proces_verbaal_gemeentelijk_stembureau_bijlage_1_en_bijlage_2 "pdf" https://www.elburg.nl >> "$(stad 0230)"
    ...
    ../urls-from-html.py https://www.edam-volendam.nl/uitslagen-verkiezing-europees-parlement-2024 | grep -v Totaaluitslag > "$(stad 0385)"
