...
pushd 2024-EP
    # A
    ../urls-from-html.py https://www.almere.nl/bestuur/verkiezingen/processen-verbaal-verkiezing-europees-parlement-2024".pdf" https://www.almere.nl > "$(stad 0034)"
    ../urls-from-html.py https://www.alphenaandenrijn.nl/Verkiezingen/UitslagEP2024 dsresource https://www.alphenaandenrijn.nl > "$(stad 0484)"
    wget -O amsterdam.json --no-check-certificate "https://api.data.amsterdam.nl/v1/verkiezingen/processenverbaal/?verkiezingsjaar=2024&page_size=10000&documentnaam[like]=*"
    cat amsterdam.json | jq -r '._embedded.processenverbaal[].uri' > "$(stad 0363)"
    ../urls-from-html.py https://www.asten.nl/gemeentebestuur-en-organisatie/verkiezingen/tweede-kamer-verkiezingen/voorlopige-verkiezingsuitslag-europees-parlement-2024 ".pdf" https://www.asten.nl | grep -v docreader > "$(stad 0743)"
    ../urls-from-html.py https://www.almelo.nl/uitslagenverkiezingen ".pdf" https://www.almelo.nl > "$(stad 0141)"
    ../urls-from-html.py https://www.arnhem.nl/Bestuur/Overig/verkiezingen/Telling_en_processen_verbaal_Europees_Parlement_2024 "dsresource" https://www.arnhem.nl | sort -u --version-sort > "$(stad 0202)"
    ../urls-from-html.py https://www.aaenhunze.nl/Bestuur/Verkiezingen/Proces_verbalen_stembureaus_donderdag_6_juni "dsresource" https://www.aaenhunze.nl | sort -u --version-sort > "$(stad 1680)"
    ../urls-from-html.py https://www.alkmaar.nl/verkiezingsuitslagen/ | sort -u > "$(stad 0361)"
    ../urls-from-html.py https://www.gemeentealtena.nl/verkiezingen/verkiezingen-europees-parlement-2024 ".pdf" https://www.gemeentealtena.nl > "$(stad 1959)"
    ...
    ../urls-from-html.py https://www.aalsmeer.nl/bestuur-organisatie/publicatie/verkiezingen_uitslagen_definitieve-uitslag-verkiezing-europees-parlement-2024 ".pdf" https://www.aalsmeer.nl > "$(stad 0358)"
    ../urls-from-html.py https://www.amersfoort.nl/verkiezingsuitslagen > "$(stad 0307)"
	../urls-from-html.py https://www.ameland.nl/verkiezing-europees-parlement-2024 > "$(stad 0060)"
	../urls-from-html.py https://www.apeldoorn.nl/tk-verkiezingen-2023/uitslag-verkiezing-europees-parlement-2024 ".pdf" https://www.apeldoorn.nl > "$(stad 0200)"
    ...
    ../urls-from-html.py https://www.alblasserdam.nl/Bestuur_Organisatie/Alle_onderwerpen/Verkiezingen/Tweede_Kamerverkiezing/Uitslag_Europees_Parlement_Alblasserdam ".pdf" https://www.alblasserdam.nl > "$(stad 0482)"
    ...
    ../urls-from-html.py https://www.borsele.nl/processen-verbaal-verkiezing-europees-parlement-2024 > "$(stad 0654)"
    ...
    ../urls-from-html.py https://www.bergeijk.nl/uitslag-verkiezing-europees-parlement-2024 | grep -v docreader > "$(stad 1724)"
    ...
    ../urls-from-html.py https://www.barneveld.nl/over-barneveld/verkiezingen/verkiezing-europees-parlement-2024/uitslag-verkiezingen ".pdf" https://www.barneveld.nl > "$(stad 0203)"
    ../urls-from-html.py https://www.beuningen.nl/projecten/Europees_Parlement_2024/Uitslag_verkiezing ".org" https://www.beuningen.nl | grep -v bestuur_en_organisatie > "$(stad 0209)"
    echo "https://www.beuningen.nl/projecten/Europees_Parlement_2024/Uitslag_verkiezing/0209_Proces_verbaal_GSB_TK23.pdf" >> "$(stad 0209)"
    ...
    ../urls-from-html.py https://www.bergen.nl/europees-parlement-2024 > "$(stad 0893)"
    ...
    ../urls-from-html.py https://www.borger-odoorn.nl/voorlopige-uitslag-verkiezing-europees-parlement-2024 "file" https://www.borger-odoorn.nl | grep -v gemeenteborgerodoorncsv | grep -v controleprotocol-en-telling > "$(stad 1681)"
    ../urls-from-html.py https://www.bergenopzoom.nl/verkiezingen/uitslagen > "$(stad 0748)"
    ../urls-from-html.py https://www.bodegraven-reeuwijk.nl/uitslag-verkiezing-europees-parlement-2024 ".pdf" https://www.bodegraven-reeuwijk.nl > "$(stad 1901)"
    # Brunssum
    ...
    ../urls-from-html.py https://www.diemen.nl/Onderwerpen/Verkiezingen/Tweede_kamer_verkiezingen_2023/Definitieve_einduitslag_Europees_Parlement_2024 ".pdf" https://www.diemen.nl > "$(stad 0384)"
    ../urls-from-html.py https://www.deurne.nl/uitslag-verkiezingen-europees-parlement-2024 | grep -v docreader | grep -v totaaluitslag > "$(stad 0762)"
    ...
    ../urls-from-html.py https://www.debilt.nl/bestuur-en-organisatie/verkiezingen/voorlopige-uitslagen-verkiezing-europees-parlement-2024 ".pdf" https://www.debilt.nl | grep -v docreader > "$(stad 0310)"
    ...
    ../urls-from-html.py https://drimmelen.nl/uitslagen-van-de-verkiezing-europees-parlement-2024 "file" https://drimmelen.nl | grep -v docreader | grep -v 11318/download > "$(stad 1719)"
    ...
    ../urls-from-html.py https://www.dinkelland.nl/verkiezing-europees-parlement-2024 "file" https://www.dinkelland.nl | grep -v .csv > "$(stad 1774)"
    ../urls-from-html.py https://www.dantumadiel.frl/nieuwsoverzicht-0/definitieve-uitslag-verkiezing-europees-parlement-2024 > "$(stad 1891)"
    ../urls-from-html.py https://www.dantumadiel.frl/processen-verbaal-verkiezingen-europees-parlement-2024-0 >> "$(stad 1891)"
    ...
    # E
    ../urls-from-html.py https://www.eindhoven.nl/bestuur-en-beleid/verkiezing-europees-parlement-2024/uitslagen-europese-verkiezingen | grep -v docreader > "$(stad 0772)"
    ../urls-from-html.py https://gemeente.emmen.nl/processen-verbaal "file" https://gemeente.emmen.nl | grep -v csv > "$(stad 0114)"
    ../urls-from-html.py https://www.epe.nl/voorlopige-verkiezingsuitslag > "$(stad 0232)"
    ../urls-from-html.py https://www.elburg.nl/Bestuur_en_organisatie/Verkiezingen/Uitslag_Europees_Parlement/Uitslag_Europees_Parlement "pdf" https://www.elburg.nl > "$(stad 0230)"
    ../urls-from-html.py https://www.ermelo.nl/europese-verkiezing/uitslagen-europees-parlement-2024 ".pdf" https://www.ermelo.nl > "$(stad 0233)"
    ../urls-from-html.py https://www.eersel.nl/verkiezingen | grep -v docreader > "$(stad 0770)"
    ...
    ../urls-from-html.py https://www.eemsdelta.nl/uitslag-europees-parlementsverkiezing-2024 > "$(stad 1979)"
    ../urls-from-html.py https://www.etten-leur.nl/uitslagen-europese-verkiezing/ > "$(stad 0777)"
    ../urls-from-html.py https://www.edam-volendam.nl/uitslag-verkiezingen-europees-parlement | grep -v Totaaluitslag > "$(stad 0385)"
    ../urls-from-html.py https://www.echt-susteren.nl/verkiezingsuitslag | grep -v docreader > "$(stad 1711)"
    ../urls-from-html.py https://www.eijsden-margraten.nl/nl/Actueel/Verkiezingen.html "EP24" https://www.eijsden-margraten.nl | grep /1903_ > "$(stad 1903)"
    ../urls-from-html.py https://www.eemnes.nl/Verkiezing_Europees_Parlement/Uitslag_verkiezing "dsresource" https://www.eemnes.nl | grep -v 244e352b-6749-493e-bddf-7fb40b01e871 > "$(stad 0317)"
    ../urls-from-html.py https://www.ede.nl/bestuur-en-organisatie/verkiezingen-europees-parlement-1 ".pdf" https://www.ede.nl > "$(stad 0228)"

    # G
    ../urls-from-html.py https://www.geertruidenberg.nl/uitslagen-europese-verkiezingen-2024 ".pdf" https://www.geertruidenberg.nl > "$(stad 0779)"
    ../urls-from-html.py https://www.geldrop-mierlo.nl/opkomstcijfers-en-processen-verbaal-europese-parlementsverkiezingen-2024 > "$(stad 1771)"
    ../urls-from-html.py https://www.gemert-bakel.nl/uitslagen-van-de-europees-parlementsverkiezing-in-de-gemeente-gemert-bakel "pdf" https://www.gemert-bakel.nl > "$(stad 1652)"
    ../urls-from-html.py https://www.gennep.nl/uitslag-verkiezingen-europees-parlement-2024 > "$(stad 0907)"
    ../urls-from-html.py https://www.gilzerijen.nl/verkiezingsuitslagen ".pdf" https://www.gilzerijen.nl > "$(stad 0784)"
    ../urls-from-html.py https://www.goeree-overflakkee.nl/uitslag-verkiezing-europees-parlement-2024 | grep -v docreader > "$(stad 1924)"
    ../urls-from-html.py https://www.goes.nl/europees-parlementsverkiezing-2024 > "$(stad 0664)"
    ../urls-from-html.py https://www.goirle.nl/verkiezingen ".pdf" https://www.goirle.nl > "$(stad 0785)"
    ../urls-from-html.py https://gooisemeren.nl/verkiezing-europees-parlement-6-juni-2024/uitslag-verkiezing-europees-parlement/ ".pdf" https://gooisemeren.nl > "$(stad 1942)"
    ../urls-from-html.py https://www.gorinchem.nl/verkiezing-europees-parlement/voorlopige-uitslag-verkiezing-europees-parlement/processen-verbaal > "$(stad 0512)"
    ...
    wget -nv -nd -nc -np -r --remote-encoding=utf-8 --local-encoding=utf-8 --spider --no-parent https://documenten.groningen.nl/EP2024/ 2>&1 | grep "pdf 200 OK" | awk '{print $4}' > "$(stad 0014)"
    ../urls-from-html.py https://www.gulpen-wittem.nl/onderwerpen/verkiezingen/uitslag-verkiezingen "eo24.*pdf" https://www.gulpen-wittem.nl > "$(stad 1729)"

    # H
    ../urls-from-html.py https://www.gemeentehw.nl/verkiezingen/uitslagen/ > "$(stad 1963)"
    ...
    ../urls-from-html.py https://www.hardenberg.nl/verkiezingen/uitslagen2024 ".pdf" https://www.hardenberg.nl | uniq > "$(stad 0160)"
    ../urls-from-html.py https://www.harderwijk.nl/europese-verkiezingen/uitslagen-verkiezingen ".pdf" https://www.harderwijk.nl > "$(stad 0243)"
    ../urls-from-html.py https://www.hardinxveld-giessendam.nl/Bestuur/Gemeenteraad/Verkiezingen/Processen_verbaal_Europees_Parlementsverkiezing_2024_Hardinxveld_Giessendam ".pdf" https://www.hardinxveld-giessendam.nl/ > "$(stad 0523)"
    ../urls-from-html.py https://www.harlingen.nl/verkiezingen | grep -v stemmen_ > "$(stad 0072)"
    ../urls-from-html.py https://www.hattem.nl/Inwoners/Verkiezingen/Uitslag_verkiezing_Europees_Parlement_2024 dsresource https://www.hattem.nl > "$(stad 0244)"
    ../urls-from-html.py https://www.heemskerk.nl/over-heemskerk/verkiezingen/europese-parlementsverkiezingen ".pdf" https://www.heemskerk.nl > "$(stad 0396)"
    ../urls-from-html.py https://www.heemstede.nl/verkiezingen/uitslagen ".pdf" https://www.heemstede.nl > "$(stad 0397)"
    ../urls-from-html.py https://www.heerde.nl/Bestuur_en_organisatie/Verkiezingen/Verkiezingen_Europees_Parlement_2024/Processen_verbaal dsresource https://www.heerde.nl > "$(stad 0246)"
    ../urls-from-html.py https://www.heerenveen.nl/actueel/verkiezingen/uitslag-verkiezingen-europees-parlement/ | grep -v uitslag[-_] > "$(stad 0074)"
    ../urls-from-html.py https://www.heerlen.nl/uitslag-verkiezingen > "$(stad 0917)"
    ...
    ../urls-from-html.py https://hethogeland.nl/bestuur-en-organisatie/verkiezingen/verkiezing-europees-parlement-6-juni-2024 ".pdf" https://hethogeland.nl > "$(stad 1966)"
    ../urls-from-html.py https://hethogeland.nl/bestuur-en-organisatie/verkiezingen/verkiezing-europees-parlement-6-juni-2024/proces-verbaal-per-stembureau ".pdf" https://hethogeland.nl >> "$(stad 1966)"
    ../urls-from-html.py https://www.heumen.nl/uitslag-verkiezing-europees-parlement > "$(stad 0252)"
    ...
    ../urls-from-html.py https://www.huizen.nl/definitieve-uitslag-verkiezing-europees-parlement-in-huizen-2024 | grep -v docreader > "$(stad 0406)"
    ../urls-from-html.py https://www.gemeentehulst.nl/Verkiezingen/Europese_Verkiezingen dsresource https://www.gemeentehulst.nl | grep -v pinterest > "$(stad 0677)"
    ...
    # L
    ../urls-from-html.py https://www.laarbeek.nl/uitslagen-europese-verkiezingen-2024 file https://www.laarbeek.nl > "$(stad 1659)"
    ../urls-from-html.py https://www.gemeentelandvancuijk.nl/processen-verbaal-verkiezingen-europees-parlement-2024 ".pdf" https://www.gemeentelandvancuijk.nl > "$(stad 1982)"
    ../urls-from-html.py https://www.landgraaf.nl/processen-verbaal-verkiezingen > "$(stad 0882)"
    ../urls-from-html.py https://www.landsmeer.nl/verkiezingen_/ bestand https://www.landsmeer.nl > "$(stad 0415)"
    ../urls-from-html.py https://www.lansingerland.nl/politiek-en-organisatie/verkiezingen-europees-parlement/processen-verbaal-europees-parlementsverkiezing-2024/ > "$(stad 1621)"
    ../urls-from-html.py https://www.laren.nl/Verkiezing_Europees_Parlement/Uitslag_verkiezing dsresource https://www.laren.nl > "$(stad 0417)"
    ../urls-from-html.py https://gemeente.leiden.nl/verkiezingen-europees-parlement-2024/verslagen-verkiezingen-europees-parlement/ ".pdf" https://gemeente.leiden.nl > "$(stad 0546)"
    ../urls-from-html.py https://www.leiderdorp.nl/verkiezingen ".pdf" https://www.leiderdorp.nl > "$(stad 0547)"
    ../urls-from-html.py https://www.lv.nl/voorlopige-uitslag-verkiezingen-europees-parlement "/file" https://www.lv.nl > "$(stad 1916)"
    ../urls-from-html.py https://www.lelystad.nl/4/verkiezingen/verkiezingsuitslagen/Europees-Parlement-2024.html ".pdf" https://www.lelystad.nl > "$(stad 0995)"
    ../urls-from-html.py https://www.leudal.nl/uitslag-verkiezing-europees-parlement-2024 > "$(stad 1640)"
    ../urls-from-html.py https://www.leusden.nl/verkiezingen/uitslagen/uitslag-verkiezingen-van-het-europees-parlement-2024 ".pdf" https://www.leusden.nl > "$(stad 0327)"
    ../urls-from-html.py https://www.lingewaard.nl/uitslagen > "$(stad 1705)"
    ../urls-from-html.py https://www.lisse.nl/verkiezingen/proces-verbalen ".pdf" https://www.lisse.nl > "$(stad 0553)"
    ../urls-from-html.py https://www.lochem.nl/bestuur-en-organisatie/verkiezingen/uitslagen ".pdf" https://www.lochem.nl > "$(stad 0262)"
    ../urls-from-html.py https://www.loonopzand.nl/organisatie-en-politiek/verkiezingen-europees-parlement/verkiezingsuitslag-europees-parlement ".pdf" https://www.loonopzand.nl > "$(stad 0809)"
    ../urls-from-html.py https://www.lopik.nl/uitslag-verkiezingen-europees-parlement | uniq > "$(stad 0331)"
    ../urls-from-html.py https://www.leeuwarden.nl/uitslagen-en-processen-verbaal-europese-verkiezingen-2024/ | sort -u --version-sort

    # M
    ../urls-from-html.py https://www.maasdriel.nl/inwoner-en-ondernemer/verkiezingen/verkiezing-europees-parlement-2024/ ".pdf" https://www.maasdriel.nl > "$(stad 0263)"
    ../urls-from-html.py https://www.gemeentemaasgouw.nl/verkiezingsuitslag > "$(stad 1641)"
    ../urls-from-html.py https://www.maassluis.nl/uitslagen-verkiezingen-europees-parlement-2024 > "$(stad 0556)"
    ../urls-from-html.py https://www.gemeentemaastricht.nl/verkiezingen/uitslagen-verkiezingen-europees-parlement-2024 ".pdf" https://www.gemeentemaastricht.nl > "$(stad 0935)"
    ../urls-from-html.py https://www.medemblik.nl/raad-en-bestuur/verkiezing-europees-parlement/uitslag-verkiezing-europees-parlement/alle-uitslagen-per-stembureau ".pdf" https://www.medemblik.nl > "$(stad 0420)"
    ../urls-from-html.py https://www.meerssen.nl/verkiezingen/uitslag_/uitslag_verkiezingen_europees_parlement/ "bestand" https://www.meerssen.nl > "$(stad 0938)"
    ../urls-from-html.py https://www.meierijstad.nl/Alle_onderwerpen/Bestuur_en_organisatie/Verkiezingen/Verkiezingen_Europees_Parlement_donderdag_6_juni_2024/Voorlopige_opkomst_en_uitslag_verkiezingen_Europees_Parlement/Processen_verbaal ".pdf" https://www.meierijstad.nl > "$(stad 1948)"
    ../urls-from-html.py https://www.meppel.nl/Inwoner/Burgerzaken/Verkiezingen/Uitslag_verkiezingen_Europees_Parlement_6_juni_2024/De_processen_verbaal_van_de_stembureaus ".pdf" https://www.meppel.nl > "$(stad 0119)"
    ../urls-from-html.py https://www.middendelfland.nl/uitslag-europees-parlement > "$(stad 1842)"
    ../urls-from-html.py https://www.middendrenthe.nl/verkiezingen/uitslag-verkiezingen ".pdf" https://www.middendrenthe.nl > "$(stad 1731)"
    ../urls-from-html.py https://www.midden-groningen.nl/uitslagen > "$(stad 1952)"
    ../urls-from-html.py https://www.moerdijk.nl/web/Verkiezingen/Uitslag-verkiezingen-Europees-Parlement-2024.html ".pdf" https://www.moerdijk.nl | grep -v factsheet > "$(stad 1709)"
    ../urls-from-html.py https://www.montferland.info/uitslagen-verkiezingen-voor-het-europees-parlement-2024 > "$(stad 1955)"
    ../urls-from-html.py https://www.montfoort.nl/Alle_onderwerpen/Bestuur_en_organisatie/Verkiezingen/Uitslag_verkiezingen ".pdf" https://www.montfoort.nl > "$(stad 0335)"
    ../urls-from-html.py https://www.mookenmiddelaar.nl/uitslag-europese-verkiezingen-van-6-juni-2024 | grep -v huisregels > "$(stad 0944)"
    ../urls-from-html.py https://www.molenlanden.nl/uitslag-europees-parlementsverkiezing-6-juni-2024 > "$(stad 1978)"
    ...
    ../urls-from-html.py https://www.oisterwijk.nl/bestuur-en-organisatie/verkiezingen-europees-parlement ".pdf" https://www.oisterwijk.nl > "$(stad 0824)"
    ../urls-from-html.py https://www.gemeente-oldambt.nl/documenten-met-verkiezingsresultaten ".pdf" https://www.gemeente-oldambt.nl > "$(stad 1895)"
    ../urls-from-html.py https://www.oldebroek.nl/Bestuur_en_organisatie/Verkiezingen/Uitslagen_verkiezingen ".pdf" https://www.oldebroek.nl > "$(stad 0269)"
    ../urls-from-html.py https://www.oldebroek.nl/Bestuur_en_organisatie/Verkiezingen/Uitslagen_verkiezingen/Processen_verbaal_Europees_Parlementsverkiezing_2024 ".pdf" https://www.oldebroek.nl >> "$(stad 0269)"
    ../urls-from-html.py https://www.oldenzaal.nl/verkiezingsuitslag ".pdf" https://www.oldenzaal.nl  > "$(stad 0173)"
    ../urls-from-html.py https://www.olst-wijhe.nl/bestuur/verkiezingen/uitslagen-verkiezingen/uitslag-verkiezingen-europees-parlement-2024> "$(stad 1773)"
    ../urls-from-html.py https://www.ommen.nl/verkiezing-europees-parlement-2024/uitslagen-kennisgevingen/ | sort -u --version-sort > "$(stad 0175)"
    ../urls-from-html.py https://www.oostgelre.nl/uitslagen-verkiezingen-europees-parlement-6-juni-2024 ".pdf" https://www.oostgelre.nl > "$(stad 1586)"
    ../urls-from-html.py https://oostzaan.nl/verkiezingen/uitslagen-verkiezingen-europees-parlement-2024 ".pdf" https://oostzaan.nl > "$(stad 0431)"
    ../urls-from-html.py https://www.opsterland.nl/verkiezingen/uitslagen | grep -v docreader > "$(stad 0086)"
    ../urls-from-html.py https://www.oss.nl/Tonen-op-pagina-standaard/Voorlopige-uitslag-verkiezingen-Europees-Parlement.htm "pdf" https://www.oss.nl > "$(stad 0828)"
    ../urls-from-html.py https://www.oude-ijsselstreek.nl/processen-verbaal > "$(stad 1509)"
    ../urls-from-html.py https://www.ouder-amstel.nl/Home/Verkiezingen/Verkiezingen_Europees_Parlement_2024/Definitieve_uitslag_Europees_Parlement_2024 ".pdf" https://www.ouder-amstel.nl > "$(stad 0437)"
    ../urls-from-html.py https://www.oudewater.nl/Verkiezingen/Verkiezingen_2024 ".org" https://www.oudewater.nl > "$(stad 0589)"
    ...
    ../urls-from-html.py https://www.sliedrecht.nl/Bestuur_politiek/Verkiezingen/Verkiezing_Europees_Parlement/Uitslagen_Europees_Parlementsverkiezing_6_juni_2024 ".org" https://www.sliedrecht.nl/ > "$(stad 0610)"
    ../urls-from-html.py https://www.smallingerland.nl/Onderwerpen/Verkiezingen/Uitslag_verkiezingen_voor_het_Europees_Parlement "/Uitslag_Europees_Parlement_2024/" https://www.smallingerland.nl | grep -v osv4_3 > "$(stad 0090)"
    ../urls-from-html.py https://www.soest.nl/verkiezingen/uitslag-verkiezingen ".pdf" https://www.soest.nl > "$(stad 0342)"
    ../urls-from-html.py https://www.someren.nl/verkiezingen/definitieve-uitslagen ".pdf" https://www.someren.nl > "$(stad 0847)"
    ../urls-from-html.py https://www.sonenbreugel.nl/verkiezingen/uitslagen/processen-verbaal > "$(stad 0848)"
    ../urls-from-html.py https://www.staphorst.nl/uitslagen-verkiezingen-europees-parlement-2024 > "$(stad 0180)"
    ../urls-from-html.py https://www.stedebroec.nl/bestuur-en-organisatie/verkiezingen/verkiezingsuitslag/ | sort | uniq > "$(stad 0532)"
    ../urls-from-html.py https://www.gemeente-steenbergen.nl/inwoners_overzicht/verkiezingen/processen-verbaal/ bestand | grep -v osv4 > "$(stad 0851)"
    ../urls-from-html.py https://www.steenwijkerland.nl/Over_Steenwijkerland/Verkiezingen/Uitslagen_verkiezingen/Voorlopige_uitslag_Verkiezing_Europees_Parlement_2024/Processen_verbaal_van_de_stembureaus/Donderdag_6_juni_2024 ".pdf" https://www.steenwijkerland.nl > "$(stad 1708)"
    ../urls-from-html.py https://www.steenwijkerland.nl/Over_Steenwijkerland/Verkiezingen/Uitslagen_verkiezingen/Voorlopige_uitslag_Verkiezing_Europees_Parlement_2024/Processen_verbaal_van_de_stembureaus/Vrijdag_7_juni_2024 ".pdf" https://www.steenwijkerland.nl >> "$(stad 1708)"
    ../urls-from-html.py https://www.gemeentestein.nl/Uitslag-Europees-parlement-2024 ".pdf" https://www.gemeentestein.nl > "$(stad 0971)"
    ../urls-from-html.py https://stichtsevecht.nl/onderwerp/8115/uitslagen-verkiezingen-voor-leden-van-het-europees-parlement-2024-en-processen-verbaal/ > "$(stad 1904)"
    ../urls-from-html.py https://verkiezingen.sudwestfryslan.nl/EP2024 > "$(stad 1900)"
    ...
    ../urls-from-html.py https://www.schouwen-duiveland.nl/verkiezingen/documenten-uitslag-europese-verkiezingen-2024 ".pdf" https://www.schouwen-duiveland.nl > "$(stad 1676)"
    ...
    ../urls-from-html.py https://www.veenendaal.nl/inwonerszaken/verkiezingen/verkiezing-europees-parlement-2024/uitslag-verkiezingen-europees-parlement ".pdf" https://www.veenendaal.nl | grep -v docreader > "$(stad 0345)"
    ../urls-from-html.py https://www.veere.nl/uitslag-europees-parlementsverkiezing > "$(stad 0717)"
    ../urls-from-html.py https://www.veldhoven.nl/inwoners-en-ondernemers/verkiezingen/verkiezing-europees-parlement-2024/uitslag ".pdf" https://www.veldhoven.nl > "$(stad 0861)"
    ../urls-from-html.py https://www.velsen.nl/publicaties-en-uitslagen ".pdf" https://www.velsen.nl > "$(stad 0453)"
    ../urls-from-html.py https://www.venlo.nl/processen-verbaal > "$(stad 0983)"
    ../urls-from-html.py https://www.vijfheerenlanden.nl/nieuws/2024/06/10/uitslag-verkiezing-europees-parlement-2024 ".pdf" https://www.vijfheerenlanden.nl | uniq > "$(stad 1961)"
    ../urls-from-html.py https://www.vlissingen.nl/definitieve-uitslag-verkiezing-europees-parlement-2024 | grep -v docreader > "$(stad 0718)"
    ../urls-from-html.py https://www.voerendaal.nl/verkiezingen#c703 ".pdf" https://www.voerendaal.nl > "$(stad 0986)"
    ../urls-from-html.py https://vught.nl/uitslag-europese-parlementsverkiezingen ".pdf" https://vught.nl > "$(stad 0865)"
    ...
    ../urls-from-html.py https://www.zoetermeer.nl/processen-verbaal-tellingen-verkiezing-europees-parlement-2024 | grep -v docreader > "$(stad 0637)"
    ../urls-from-html.py https://www.zevenaar.nl/voorlopige-uitslag-verkiezing-europees-parlement-2024 > "$(stad 0299)" ".pdf" https://www.zevenaar.nl
    ../urls-from-html.py https://www.zeist.nl/gemeente-bestuur-en-organisatie/verkiezingen/uitslag-europese-verkiezingen ".pdf" https://www.zeist.nl | grep -v docreader > "$(stad 0355)"
    ../urls-from-html.py https://www.zeewolde.nl/verkiezingen/uitslagen ".pdf" https://www.zeewolde.nl > "$(stad 0050)"
    ../urls-from-html.py https://www.zaltbommel.nl/inwoner-en-ondernemer/verkiezingen-europees-parlement-6-juni-2024/uitslagen-verkiezingen-europees-parlement-2024 ".pdf" https://www.zaltbommel.nl > "$(stad 0297)"
    ../urls-from-html.py https://www.zuidplas.nl/processen-verbaal-van-de-stembureaus > "$(stad 1892)"
    ../urls-from-html.py https://www.zwartewaterland.nl/verkiezingen/uitslagen > "$(stad 1896)"
popd
